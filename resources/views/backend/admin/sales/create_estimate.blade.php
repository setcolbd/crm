...
<div class="content-wrapper">
	    <div class="row">
		    <div class="col-md-12 grid-margin stretch-card">
			    <div class="card">
			      <div class="card-body">
			        <h4 class="card-title text-center">Create Estimate</h4>
			        <form class="forms-sample">
			          ...
			          <div class="form-group row">
			            <label for="estimate_date" class="col-sm-2 col-form-label text-right">Estimate Date<span class="req">*</span></label>
			            <div class="col-sm-4">
			              <input type="date" class="form-control form-control-sm" id="estimate_date" name="estimate_date" placeholder=" Estimate Date" required="">
			            </div>
			            <label for="expiry_date" class="col-sm-2 col-form-label text-right">Expiry Date</label>
			            <div class="col-sm-4">
			          ...
			          <p class="text-bold text-center">Estimate Details</p>
			          <div class="form-group row">
